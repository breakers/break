var wsclient = (function() {
    ...
    var ws = null;
    var wsURI = 'ws://' + location.host  + '/WebsocketsProject/chat';
    ...
    function connect(userName) {
        ...
        if ('WebSocket' in window) {
            ws = new WebSocket('ws://' + location.host  + '/WebsocketsProject/chat' + '?userName=' + userName);
        } else if ('MozWebSocket' in window) {
            ws = new MozWebSocket('ws://' + location.host  + '/WebsocketsProject/chat' + '?userName=' + userName);
        } else {
