...
<!--  fin  del c√≥digo Google Analytics -->

</head>

 <body>
 <div><a id="fancybox" class="fancybox" href="http://www.victorica.gob.ar/noticias/2010/img/agua.jpg" data-fancybox-group="gallery" title="Bienvenido a la P·gina SEDAPAR" type="jpg"></a></div>
          ...
          <ul class="uno">
            <li>
              <div class="subnav-wrap">
                ...
                <a class="subnav_a" href="mision_vision.jsp">MisiÛn, VisiÛn y Valores</a>
          ...
          <ul class="dos">
            <li>
              <div class="subnav-wrap">
                ...
                <div class="subnav support">
                    <a class="subnav_a t1" href="#">Tecnolog√≠a</a>
                    <a class="subnav_a" href="moviles.php">M√≥viles</a>
                    <a class="subnav_a" href="intelligence.php">Business Intelligence</a>
                    <a class="subnav_a" href="integracion.php">Integraci√≥n</a>
          ...
          <ul class="tres">
            <li>
              <div class="subnav-wrap" style="width:335px;">
                ...
                <div class="subnav support">
                    <a class="subnav_a t1" href="#">Casos de √©xito</a>
                  ...
                  <a class="subnav_a" href="smooth.php">PACER SmoothCom Application</a>
                    ...
                    <a class="subnav_a" href="patologico.php">Sistema Integral de An√°lisis Patol√≥gico</a>
...
<p> Somos una empresa Peruana-Americana, con m·s de 15 aÒos en el mercado Internacional desarrollando soluciones a la medida de los requerimientos de nuestros clientes, con absoluta seriedad y calidad en los productos que entregamos. 
      ...
      <table>
        <tr>
          ...
          <td><p>Tenemos una amplia experiencia y relaciones de largo plazo con nuestros clientes en los sectores Naviero, Mar√≠timo, Puertos, ...</p><div align="right"><a href="desarrollando.php"><img src="index/img/home/plus_1.png" width="18" height="18"></a></div></td>
      ...
      <table>
        <tr>
          ...
          <td><p>Existe una amplia diversidad de compa√±√≠as consultoras en el mundo. Todas enfrentan un desaf√≠o com√∫n: proveer apoyo y soporte en TI ...</p><div align="right"><a href="nearshore.php"><img src="index/img/home/plus_2.png" width="18" height="18"></a></div></td>
        </tr>
      </table>
      <table>
        <tr>
    ...
    <div class="RIGHT">
      ...
      <div id="soluciones2">
        <h1>Soluciones Tecnol√≥gicas<img src="index/img/home/icon_gears.png"></h1>
        <ul class="sub_nav">
          <li> <a href="moviles.php">M√≥viles </a></li>
  ...
  <table>
    <tr>
      <td><h1><a href="index.jsp">Inicio</a></h1>
        ...
        <p><a href="mision_vision.jsp">MisiÛn, VisiÛn y Valores</a></p>
      ...
      <td><h1>&nbsp;</h1>
        <h1>Tecnolog√≠a </h1>
        <p><a href="moviles.php">M√≥viles </a></p>
        <p><a href="intelligence.php">Business Intelligence</a></p>
        <p><a href="integracion.php">Integraci√≥n</a></p>
      ...
      <td class="line_vert"><h1>Proyectos </h1>
        ...
        <p><a href="intermodal.php">Casos de √©xito</a></p>
        <h1><a href="alianzas.php"><br />
          </a></h1></td>
      <td class="line_vert"><h1><a href="alianzas.php">Alianzas estrat√©gicas </a></h1>
        <h1><a href="prensa.php">Prensa</a></h1>
        <h1><a href="contacto.php">Cont√°ctenos </a></h1></td>
...
<!-- Inserta bot√≥n de LinkedIn. ADC: 23/07/2012 --> 
