...
<meta name="description" content="Pagina principal de sedapar, empresa que brinda servicio de agua potable en la provincia de arequipa." />
  ...
  <link rel="stylesheet" href="css/euro/lysander.css" media="all" />	<!-- ya -->
<link rel="stylesheet" href="css/euro/renzo.css" media="all" />			<!-- ya -->
<link rel="stylesheet" href="css/euro/style1.css" media="all" />		
<link rel="stylesheet" href="css/euro/css_4xRWIdIpLDitD4bXlSkh8ZuiVKdtA1vzTJFDCU_Ztq4.css" media="all" /><!-- http://www.euroweb.de/sites/default/files/css/css_4xRWIdIpLDitD4bXlSkh8ZuiVKdtA1vzTJFDCU_Ztq4.css -->
...
<![endif]-->
  <script src="js/euro/script1.js"></script>
<script src="js/euro/script2.js"></script>
<script src="js/euro/script3.js"></script>
<script src="js/euro/script4.js"></script>
<script src="js/euro/script5.js"></script>
<script src="js/euro/script6.js"></script>
<script>
...
<body class="html front not-logged-in no-sidebars page-frontpage i18n-de " >
  <!-- Google Tag Manager -->
  <noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-P4JW3" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-P4JW3');</script>
...
<section id="login">
	...
	<div class="center">
								<h1>
									...
									<span class="blue">Sedapar</span>
									<span class="white">Intranet</span>
								</h1>
								<h4 class="red">&copy; Breakers</h4>
							</div>

	<form action="logueo" class="login" method="post" onSubmit="recordOutboundLink(this, 'Customer Login', 'Counter');">
		<input class="hidden" name="logme" type="hidden" value="1" /> 
		<input class="hidden" name="uri" type="hidden" value="counter.euroweb.de" /> 
		<label for="counter-user-block">Usuario</label> 
		<input id="counter-user-block" name="usuario" required type="text" /><br />
		<label for="counter-pw-block">Password</label> 
		<input id="counter-pw-block" name="password" required type="password" /> 
		<input class="right" name="submitlogin" type="submit" value="Entrar" />
	</form>
</div>
...
<div id="wrapper">
        ...
        <section class="block block-views " id="block-views-startseiten-slideshow-block">
...
<div class="skin-default">
  ...
  <div id="views_slideshow_cycle_main_startseiten_slideshow-block" class="views_slideshow_cycle_main views_slideshow_main"><div id="views_slideshow_cycle_teaser_section_startseiten_slideshow-block" class="views-slideshow-cycle-main-frame views_slideshow_cycle_teaser_section">
  <div id="views_slideshow_cycle_div_startseiten_slideshow-block_0" class="views-slideshow-cycle-main-frame-row views_slideshow_cycle_slide views_slideshow_slide views-row-1 views-row-odd">
  <div class="views-slideshow-cycle-main-frame-row-item views-row views-row-0 views-row-first views-row-odd">
                <img typeof="foaf:Image" src="img/6.jpg" width="2000" height="750" alt="" />   
...
<div id="views_slideshow_cycle_div_startseiten_slideshow-block_1" class="views-slideshow-cycle-main-frame-row views_slideshow_cycle_slide views_slideshow_slide views-row-2 views_slideshow_cycle_hidden views-row-even">
  <div class="views-slideshow-cycle-main-frame-row-item views-row views-row-0 views-row-first views-row-odd">
                <img typeof="foaf:Image" src="img/7.jpg" width="2000" height="750" alt="" />   
              <div class="header-slide">
<article>
<hgroup>
<h2><a href="http://radio.rpp.com.pe/cuidaelagua/peru-necesita-mas-represas-para-afrontar-escasez-de-agua-afirma-experto/">Sedapar renueva sus represas</a></h2>   
              <h3>Mejor servicio para todos</h3>
</hgroup>   
              <div class="header-slide-body"><p>El Perú posee el 5% de toda el agua dulce del planeta pero ¿por qué es escasa en ciertas zonas del país, al punto que existen 244 conflictos por agua? ¿Por qué los estudios internacionales señalan que sufriremos de escasez de este recurso en pocos años?</p>
</div>
</article>
</div>   
</div>
</div>
<div id="views_slideshow_cycle_div_startseiten_slideshow-block_2" class="views-slideshow-cycle-main-frame-row views_slideshow_cycle_slide views_slideshow_slide views-row-3 views_slideshow_cycle_hidden views-row-odd">
  <div class="views-slideshow-cycle-main-frame-row-item views-row views-row-0 views-row-first views-row-odd">
                <img typeof="foaf:Image" src="img/8.jpg" width="2000" height="750" alt="" />   
              <div class="header-slide">
<article>
<hgroup>
<h2><a href="http://www.google.com">¡Puede ahorra mucha agua utilizando el cabezal fijo!</a></h2>   
              <h3>Ahorrar agua es fácil</h3>
</hgroup>   
              <div class="header-slide-body"><p>Cada vez más personas comprenden la importancia y el valor del agua. El agua potable es el alimento más importante, ¡y es insustituible! Por ello, ahorrar agua es una medida inteligente, para nosotros y para el medioambiente.</p>
</div>
</article>
</div>   
</div>
</div>
<div id="views_slideshow_cycle_div_startseiten_slideshow-block_3" class="views-slideshow-cycle-main-frame-row views_slideshow_cycle_slide views_slideshow_slide views-row-4 views_slideshow_cycle_hidden views-row-even">
  <div class="views-slideshow-cycle-main-frame-row-item views-row views-row-0 views-row-first views-row-odd">
                <img typeof="foaf:Image" src="img/9.jpg" width="2000" height="750" alt="" />   
              <div class="header-slide">
<article>
<hgroup>
<h2><a href="http://www.tareasya.com.mx/index.php/tareas-ya/primaria/tercer-grado/ciencias-naturales/925-Importancia-del-agua.html">Aprendamos un poco sobre el agua</a></h2>   
              <h3>Es facil saber la importancia</h3>
</hgroup>   
              <div class="header-slide-body"><p>El agua que se usa para que las personas la beban, se llama potable. El agua potable debe ser transparente, sin olor y sin sabor; si el agua se ve turbia, no debe consumirse porque puede contener impurezas y provocar enfermedades.</p>
</div>
</article>
</div>   
</div>
</div>
<div id="views_slideshow_cycle_div_startseiten_slideshow-block_4" class="views-slideshow-cycle-main-frame-row views_slideshow_cycle_slide views_slideshow_slide views-row-5 views_slideshow_cycle_hidden views-row-odd">
  <div class="views-slideshow-cycle-main-frame-row-item views-row views-row-0 views-row-first views-row-odd">
                <img typeof="foaf:Image" src="img/10.jpg" width="2000" height="750" alt="" />   
              <div class="header-slide">
<article>
<hgroup>
...
<!-- /.region -->
      ...
      <h2 id="claim">Sedapar Arequipa <strong>siempre contigo.</strong></h2>
...
<!-- /.region -->
		...
		<header id="page-top">
				<h1><img src="img/logo-tab1.png" title="Sedapar - Profesionales a su servicio">Sedapar - Profesionales a su servicio</a></h1>
				
				<section id="intro-region">
																							</section>
...
<!-- /.region -->
          ...
          <nav class="block block-menu " id="block-menu-menu-zweites-hauptmen-">
          
            
      <ul><li><a href="/blog" title="Blog sedapar sobre nuestra actividades">Blog</a></li>
...
<!-- /.region -->
 ...
 <input title="Busqueda en la web sedapar." type="search" id="edit-search-block-form--2" name="search_block_form" value="" size="15" maxlength="128" class="form-text form-search" />
<br /><div class="form-actions form-wrapper" id="edit-actions"><input type="submit" id="edit-submit" name="op" value="Suche" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-k0hztLfOpLisHq8UqH0jz_vAmp0kSFriIu3nCfHF_6A" />
...
<!-- /.region -->
    ...
    <h2><span class="icon-teaser-produkte">&nbsp;</span> Calidad</h2>
    <p>Sedapar trabaja en cumplimiento de los mas altos estandares de calidad iso-434343.</p>
    <a class="button right" href="#/produkte">Mas sobre calidad</a></article>
<article class="column4" id="teaser-portfolio">
    <h2><span class="icon-teaser-portfolio">&nbsp;</span> Tecnologia</h2>
    <p>Nos encargamos de estar al dia en la tecnologia para optimizar la calidad en el servicio.</p>
...
<!-- /.region -->
    	...
    	<article id="node-1626" class="node node-page node-promoted node-page node-promoted portfolio"  about="/node/1626" typeof="foaf:Document">
...
<!-- /.region -->
		...
		<footer id="page-bottom">
          ...
          <nav class="block block-menu column4 corporative" id="block-menu-menu-corporative-sites">
...
<!-- /.region -->
								<img src="img/europe-map-blank.png" alt="Euroweb-Standorte in Europa" />
						</div>
...
<!-- /.region -->
        ...
        <section class="block block-views " id="block-views-award-slideshow-awards">
      ...
      <li class="jcarousel-item-7 odd">              <a href="http://www.euroweb.de/unternehmen#node-1046"><img typeof="foaf:Image" src="http://www.euroweb.de/sites/default/files/awards/ima-bestinclass-2012.png" width="67" height="90" alt="Interactive Media Awards Best In Class 2012" /></a>   
</li>
      <li class="jcarousel-item-8 even">              <a href="http://www.parallels.com/de/partners/find/sp/company,21669"><img typeof="foaf:Image" src="http://www.euroweb.de/sites/default/files/awards/footer-parallels-silver.png" width="138" height="90" alt="Parallels Silver Partner" /></a>   
</li>
      <li class="jcarousel-item-9 odd">              <a href="http://www.parallels.com/de/partners/find/sp/company,21669"><img typeof="foaf:Image" src="http://www.euroweb.de/sites/default/files/awards/footer-parallels-certified.png" width="138" height="90" alt="Parallels Certified Automation Engineer" /></a>   
</li>
      <li class="jcarousel-item-10 even">              <a href="http://www.euroweb.de/unternehmen#node-1046"><img typeof="foaf:Image" src="http://www.euroweb.de/sites/default/files/awards/media-momentum2012b.png" width="95" height="90" alt="" /></a>   
</li>
      <li class="jcarousel-item-11 odd">              <a href="http://www.euroweb.de/unternehmen#node-1046"><img typeof="foaf:Image" src="http://www.euroweb.de/sites/default/files/awards/media-momentum2010_0.png" width="95" height="90" alt="Media Momentum 2010" /></a>   
</li>
      ...
      <li class="jcarousel-item-15 odd">              <a href="http://www.euroweb.de/unternehmen#node-1046"><img typeof="foaf:Image" src="http://www.euroweb.de/sites/default/files/awards/kununu-topcompany_0.png" width="126" height="90" alt="Kununu Top Company" /></a>   
</li>
      <li class="jcarousel-item-16 even">              <a href="http://www.euroweb.de/unternehmen#node-1046"><img typeof="foaf:Image" src="http://www.euroweb.de/sites/default/files/awards/kununu-opencompany_0.png" width="125" height="90" alt="Kununu Open Company" /></a>   
</li>
...
<!-- /.region -->
      ...
      <ul><li><a href="/impressum">Legal</a></li>
