...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta charset="utf-8">
		<title>Dashboard - Felix Apaza</title>
		...
		<script src="js/ace-extra.min.js"></script><style type="text/css"></style>
					...
					<ul class="nav ace-nav">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li>
									<a href="#">
										<img src="img/users/avatar.png" class="msg-photo" alt="Alex&#39;s Avatar">
										<span class="msg-body">
								...
								<li>
									<a href="#">
										<img src="img/users/avatar3.png" class="msg-photo" alt="Susan&#39;s Avatar">
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src="img/users/avatar4.png" class="msg-photo" alt="Bob&#39;s Avatar">
										<span class="msg-body">
											<span class="msg-title">
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe&#39;s avatar" src="img/users/user1.jpg">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe&#39;s avatar" src="img/users/avatar2.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe&#39;s avatar" src="img/users/avatar.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe&#39;s avatar" src="img/users/avatar5.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe&#39;s avatar" src="img/users/avatar2.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan&#39;s avatar" src="img/users/avatar3.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe&#39;s avatar" src="img/users/avatar4.png">
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe&#39;s avatar" src="img/users/avatar1.png">
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 300px;"><div class="comments" style="overflow: hidden; width: auto; height: 300px;">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe&#39;s Avatar" src="img/users/avatar.png">
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer&#39;s Avatar" src="img/users/avatar1.png">
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe&#39;s Avatar" src="img/users/avatar2.png">
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita&#39;s Avatar" src="img/users/avatar3.png">
																	</div>
												...
												<div class="widget-main no-padding">
													<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 300px;"><div class="dialogs" style="overflow: hidden; width: auto; height: 300px;">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa&#39;s Avatar" src="img/users/avatar1.png">
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob&#39;s Avatar" src="img/users/user1.jpg">
															</div>
					...
					<div class="ace-settings-box" id="ace-settings-box">
						<div>
							<div class="pull-left">
								...
								<div class="dropdown dropdown-colorpicker"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
									<span class="btn-colorpicker" style="background-color:#222A2D"></span></a>
									<ul class="dropdown-menu dropdown-caret">
										<li><a class="colorpick-btn" href="#" style="background-color:#438EB9;" data-color="#438EB9"></a></li>
										<li><a class="colorpick-btn selected" href="#" style="background-color:#222A2D;" data-color="#222A2D"></a></li><li><a class="colorpick-btn" href="#" style="background-color:#C6487E;" data-color="#C6487E"></a></li><li><a class="colorpick-btn" href="#" style="background-color:#D0D0D0;" data-color="#D0D0D0"></a></li>
									</ul>
								</div>
							</div>
...
<div class="tooltip top in" style="top: 447px; left: 980px; display: none;"><div class="tooltip-inner">social networks : 38.7%</div></div></body></html>