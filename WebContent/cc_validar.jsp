				...
				<ul class="nav nav-list">
					...
					<li class="active open"><a href="#" class="dropdown-toggle"> <i
						...
						<ul class="submenu">
							...
							<li class="active"><a href="cc_validar.jsp"> <i
									class="icon-double-angle-right"></i> <fmt:message
				...
				<div class="page-content">
					<div class="page-header">
						...
						<h1> <fmt:message key="label.Categoria" />
							<small> <i class="icon-double-angle-right"></i> <fmt:message key="label.VerificarCambioCategoria" /></small>
						</h1>
					</div>
					<!-- /.page-header -->
						...
						<div class="col-xs-12">
							...
							<div class="widget-header header-color-red">
								<h5 class="bigger lighter">
									<i class="icon-table"></i>
										Verificar Expediente Cambio de Categoría
										</h5>
							</div>
							...
							<div class="table-responsive"><br>
									...
									<div class="widget-body">
											<div class="widget-main">
											<div class="form-group">
											<label class="col-sm-4 control-label no-padding-right" for="form-field-expediente"><strong>Detalles de Inspección</strong></label>
									</div>
									...
									<div class="form-group">
												...
												<label class="col-sm-2 control-label no-padding-right" for="form-field-asistente">Categoría Anterior:</label>
												<input type="text" size="20" name="categoria" id="form-field-categoria"/>
												</div>

												<label class="col-sm-2 control-label no-padding-right" for="form-field-asistente">Nueva Categoría:</label>
												<input type="text" size="20" name="categoria" id="form-field-categoria"/>
												</div>
