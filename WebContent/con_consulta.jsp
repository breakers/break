...
<% request.getSession().setAttribute("pagina", "con_consulta"); %>
									...
									<div class="col-sm-30">
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="smaller">Buscar Contrato</h4>
											</div>
											...
											<div class="widget-body">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label no-padding-right" for="form-field-NomCli">Nombre Cliente:</label>
												
													<div class="col-sm-9">
															<input type="text" name="NomCli" id="form-field-NomCli"/>
													</div>
												</div><!-- form-group -->
												...
												<div class="form-group">
													<label class="col-sm-2 control-label no-padding-right" for="form-field-Fecha">Fecha:</label>
